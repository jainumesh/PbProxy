...
For Echo server:
Client Side: pbproxy -k <keyfile> localhost 2223
Server Side: pbproxy -l 2223 -k <keyfile> localhost 22

For SSH, we can use 
Client Side: ssh -o "ProxyCommand pbproxy -k  <keyfile> localhost 22" localhost
Server Side: pbproxy -l 2223 -k <keyfile> localhost 22
